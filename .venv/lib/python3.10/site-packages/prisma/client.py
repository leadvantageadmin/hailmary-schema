...
SCHEMA_PATH = Path('/Users/prashantmomale/Workspace/leadvantage/hailmary/services/schema/versions/latest/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'darwin-arm64': '/Users/prashantmomale/Workspace/leadvantage/hailmary/services/schema/node_modules/prisma/query-engine-darwin-arm64', 'debian-openssl-3.0.x': '/Users/prashantmomale/Workspace/leadvantage/hailmary/services/schema/node_modules/prisma/query-engine-debian-openssl-3.0.x', 'linux-arm64-openssl-3.0.x': '/Users/prashantmomale/Workspace/leadvantage/hailmary/services/schema/node_modules/prisma/query-engine-linux-arm64-openssl-3.0.x', 'linux-musl-openssl-3.0.x': '/Users/prashantmomale/Workspace/leadvantage/hailmary/services/schema/node_modules/prisma/query-engine-linux-musl-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    prospect: 'actions.ProspectActions[models.Prospect]'
    user: 'actions.UserActions[models.User]'
    materializedviewlog: 'actions.MaterializedViewLogActions[models.MaterializedViewLog]'
    materializedviewerror: 'actions.MaterializedViewErrorActions[models.MaterializedViewError]'
    ...
    def __init__(
        ...
        *,
        ...
        self.prospect = actions.ProspectActions[models.Prospect](self, models.Prospect)
        self.user = actions.UserActions[models.User](self, models.User)
        self.materializedviewlog = actions.MaterializedViewLogActions[models.MaterializedViewLog](self, models.MaterializedViewLog)
        self.materializedviewerror = actions.MaterializedViewErrorActions[models.MaterializedViewError](self, models.MaterializedViewError)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/Users/prashantmomale/Workspace/leadvantage/hailmary/services/schema/versions/latest/schema.prisma',
        }
...
class Batch:
    ...
    prospect: 'ProspectBatchActions'
    user: 'UserBatchActions'
    materializedviewlog: 'MaterializedViewLogBatchActions'
    materializedviewerror: 'MaterializedViewErrorBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.prospect = ProspectBatchActions(self)
        self.user = UserBatchActions(self)
        self.materializedviewlog = MaterializedViewLogBatchActions(self)
        self.materializedviewerror = MaterializedViewErrorBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class MaterializedViewLogBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
    ...
    def create(
        ...
        self._batcher._add(
            method='create',
            model=models.MaterializedViewLog,
            arguments={
                'data': data,
                'include': include,
            },
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class MaterializedViewErrorBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
    ...
    def create(
        ...
        self._batcher._add(
            method='create',
            model=models.MaterializedViewError,
            arguments={
                'data': data,
                'include': include,
            },
